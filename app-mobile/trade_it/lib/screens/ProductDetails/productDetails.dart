...
class ProducasdastDetails extends StatelessWidget {
  ProducasdastDetails({Key? key, required this.productOBJ}) : super(key: key);
  Product productOBJ;
  String imgPath = "";
  bool imgExist = false;
  List imagesList = [];
  ...
  Widget build(BuildContext context) {
    if (productOBJ.productImages == null ||
        productOBJ.productImages?.isEmpty == true) {
      ...
      imgPath = ' http://10.0.2.2:5228/Images/' +
          ...
          '/';
      for (int i = 0; i < productOBJ.productImages!.length; i++) {
        imagesList.add(imgPath + productOBJ.productImages![i]["name"]);
      }
    }
    print(imagesList);
    print(imgPath);
