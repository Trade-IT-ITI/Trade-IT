                  ...
                  return SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            margin: const EdgeInsets.symmetric(horizontal: 16),
                            child: Text(state.error.startsWith("Timeout")?"Network Error":state.error)),
                      ],
                    ),
                  );
                  ...
                  return SizedBox(
                    ...
                    child: Center(
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Image.asset('assets/images/icons8-ok-100.png'),
                            Container(
                        ...
                        TextButton(
                          ...
                          onPressed: (){
                            ...
                            if(isValid == true && image != null){
                              ...
                              BlocProvider.of<AddProductCubit>(context).addProduct(product,context);
                            }
